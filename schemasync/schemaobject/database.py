...
from .table import table_schema_builder
from .procedure import procedure_schema_builder
from .collections import OrderedDict
from .trigger import trigger_schema_builder
from .view import view_schema_builder
...
class DatabaseSchema(object):
    ...
    def tables(self):
        ...
        if self._tables is None:
            self._tables = table_schema_builder(
                database=self, tables=self.parent._tables
            )
    ...
    def create(self):
        ...
        return "CREATE DATABASE `%s` %s %s;" % (
            self.name,
            self.options["charset"].create(),
            self.options["collation"].create(),
        )
